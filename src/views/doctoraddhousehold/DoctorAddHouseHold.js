        ...
        <CModal 
          ...
          onClose={setModal}
            >
              ...
              <CModalBody>
                This page is for Admin and Nurse only, You can only view the Household table.
              </CModalBody>
              <CModalFooter>
           ...
           <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
             <CButton onClick={addEmployee} block shape="pill" color="success"disabled>Add Member</CButton>
           </CCol>
           <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
...
export default DoctorAddHouseHold
