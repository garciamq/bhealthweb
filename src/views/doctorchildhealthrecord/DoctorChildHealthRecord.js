        ...
        <CCardBody>
          ...
          <CRow className="align-items-center mt-3">
            ...
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
              <CButton onClick={addEmployee} block shape="pill" color="success" >Add Child</CButton>
            </CCol>
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
              <CButton onClick={getEmployees} block shape="pill" color="info" >View Record</CButton>
            </CCol>
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
              <CButton block shape="pill" color="success" >Immunization</CButton>
            </CCol>
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
              <CButton block shape="pill" color="success" >Findings</CButton>
            </CCol>
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
              <CButton block shape="pill" color="success" >Edit</CButton>
            </CCol>
            <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
...
export default DoctorChildHealthRecord
