        ...
        <CModal 
          ...
          onClose={setModal}
            >
              ...
              <CModalBody>
                This page is for Admin and Midwife only, You can only view the Maternal Record table.
              </CModalBody>
              <CModalFooter>
           ...
           <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
             <CButton onClick={addEmployee} block shape="pill" color="success"disabled>Add Record</CButton>
           </CCol>
           <CCol col="3" sm="2" md="1" xl className="mb-3 mb-xl-0">
...
export default DoctorMaternalRecord
