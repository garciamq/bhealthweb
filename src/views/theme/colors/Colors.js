              ...
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    ...
                    <CFormText>For example : Medkits Giving</CFormText>
                  </CCol>
                </CFormGroup>
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Brgy</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CSelect custom name="select" id="select">
                      <option value="0" disabled>Select Brgy</option>
                      <option value="1">Brgy 1</option>
                      <option value="2">Brgy 2</option>
                      <option value="3">Brgy 3</option>
                    </CSelect>
                  </CCol>
                </CFormGroup>
                {/* <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="email-input">Brgy</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput type="email" id="email-input" name="email-input" placeholder="Brgy Number" autoComplete="email"/>
                    <CFormText className="help-block">For Example : Brgy 402</CFormText>
                  </CCol>
                </CFormGroup> */}
                {/* <CFormGroup row>
                  <CCol md="3">
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="date-input">Date of Event</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                ...
                <CFormGroup row>
                  <CLabel col md="3" htmlFor="file-input">Image Input</CLabel>
                  <CCol xs="12" md="9">
