...
Many tuberculosis strains resist the drugs most used to treat the disease. People with active tuberculosis must take many types of medications for months to get rid of the infection and prevent antibiotic resistance.</p>
              ...
              <small> CARD</small>
                                            ...
                                            <CCardBody>
                                                ...
                                                <CFormGroup row>
                                                    ...
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Civil Status</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. Single, Married, etc.) "/>
                                                            <CFormText>Please enter your civil status</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                    ...
                                                    <CFormGroup row>
                                                        ...
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. First Name, Last Name, Middle Name) "/>
                                                            <CFormText>Please enter your mother's name</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Blood Type</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. A, A+, A-, B, etc.) "/>
                                                            <CFormText>Please enter your blood type</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                    ...
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel>Indigenous People</CLabel>
                                                        </CCol>
                                                        <CCol md="9">
                                                            <CFormGroup variant="checkbox">
                                                                <CInputRadio className="form-check-input" id="radio1" name="radios" value="option1" />
                                                    ...
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Religion</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. Catholic, etc.) "/>
                                                            <CFormText>Please enter your religion</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Educational Attainment</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. Highschool Graduate, etc.) "/>
                                                            <CFormText>Please enter your educational attainment</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Occupation</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. N/A if none) "/>
                                                            <CFormText>Please enter your occupation</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">Family Role</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. Head / Member) "/>
                                                            <CFormText>Please enter your family role</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="text-input">CCT ID</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput id="text-input" name="text-input" placeholder="(eg. Identity Card) "/>
                                                            <CFormText>Please enter your cct id</CFormText>
                                                        </CCol>
                                                    </CFormGroup>
                                                    <CFormGroup row>
                                                        <CCol md="3">
                                                            <CLabel htmlFor="date-input">CCT Date</CLabel>
                                                        </CCol>
                                                        <CCol xs="12" md="9">
                                                            <CInput type="date" id="date-input" name="date-input" placeholder="date" />
                                                        </CCol>
            ...
            >
              ...
              <CModalBody>
                You need to sign in first before you proceed with the submission of form, by clicking continue you will be redirecting to sign in page.
              </CModalBody>
              <CModalFooter>
